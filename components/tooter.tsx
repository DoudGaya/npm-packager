        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center">
              ...
              <span className="text-xl font-bold text-primary/70">NPM-Packager</span>
            </Link>
          ...
          {/* Product Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary/60">Product</h3>
          ...
          {/* Company Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary/60">Company</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary/60">Stay Updated</h3>
            <p className="text-muted-foreground">
              Subscribe to our newsletter for the latest updates, features, and news.
            </p>
            <form className="flex flex-col sm:flex-row gap-2" onSubmit={(e) => e.preventDefault()}>
              <Input type="email" placeholder="Enter your email" className="flex-1 bg-transparent text-muted border-primary/50 " />
