...
export function PackagesTable({ packages }: PackagesTableProps) {
  ...
  const columns: ColumnDef<Package>[] = [
    ...
    },
    {
      ...
      header: "Framework",
      cell: ({ row }) => <div className="capitalize">{row.getValue("framework")}</div>,
    },
    {
      accessorKey: "status",
      header: "Status",
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => router.push(`/packages/${pkg.id}`)}>View</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => router.push(`/packages/${pkg.id}/edit`)}>Edit</DropdownMenuItem>
              <DropdownMenuItem onClick={() => router.push(`/packages/${pkg.id}/publish`)}>Publish</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        )
      },
